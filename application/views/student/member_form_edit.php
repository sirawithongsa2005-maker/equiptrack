                ...
                <div class="col-sm-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <!-- form start -->
                            <form role="form" action="<?php echo site_url('student/edit_profile'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <a class="btn btn-danger" href="<?php echo  site_url('student'); ?>" role="button"><i class="fa fa-fw fa-close"></i> ยกเลิก</a>
