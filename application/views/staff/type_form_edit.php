                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <form role="form" action="<?php echo  site_url('staff/edittype_db'); ?>" method="post" class="form-horizontal">
                                ...
                                <input type="hidden" name="t_id" value="<?php echo html_escape($query->t_id); ?>">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" placeholder="ชื่อประเภท" class="form-control" name="t_name" required value="<?php echo html_escape($query->t_name); ?>" minlength="2"  >
