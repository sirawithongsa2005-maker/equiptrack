  ...
  <section class="content">
    <div class="et-page-head">
      <div>
        ...
        <h1>สรุปการยืม–คืนตามประเภทครุภัณฑ์</h1>
        <p>เปรียบเทียบจำนวนรายการของแต่ละประเภท โดยไม่ต้องพึ่งไลบรารีจากอินเทอร์เน็ต</p>
      </div>
      <a class="btn btn-default" href="<?php echo site_url('report/bytype'); ?>"><i class="fa fa-fw fa-bars"></i> ดูแบบตาราง</a>
    </div>
    <div class="et-card">
          ...
          <div class="et-bars">
            <?php foreach ($rows as $row): $pct = $max > 0 ? round(((int)$row->total / $max) * 100, 2) : 0; ?>
              <div class="et-bar-row">
                <div class="et-bar-meta"><strong><?php echo html_escape($row->t_name); ?></strong><span><?php echo number_format((int)$row->total); ?> รายการ</span></div>
